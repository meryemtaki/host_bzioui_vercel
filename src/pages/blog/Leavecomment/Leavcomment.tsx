...
<div class="flex justify-center items-center w-screen h-screen bg-white">
	<div class="container mx-auto my-4 px-4 lg:px-20">
		...
		<div class="cardlvcm w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl">
			<div class="flex">
				<h1 class="font-bold uppercase text-5xl">Leave a <br /> Comment</h1>
			</div>
            ...
            type="email" placeholder="Email*" />
				...
				<div class="my-4">
					<textarea placeholder="Your Comment*" class="w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
				</div>
